...
module.exports = function(url, options, callback) {
  ...
  options = options || {};
  options.logger = new Logger('URL Parser');
...
function parseConnectionString(url, options) {
  ...
  urlOptions.forEach(function(option) {
    ...
    try {
      ...
      if (err instanceof AssertionError) console.trace();
  ...
  function optionCases(name, value) {
    ...
    switch (name) {
      ...
      case 'maxPoolSize':
      case 'poolSize':
        serverOptions.poolSize = validateInteger(value, options);
        replSetServersOptions.poolSize = validateInteger(value, options);
        break;
      case 'appname':
      ...
      case 'rs_name':
        ...
        break;
      case 'reconnectWait':
        replSetServersOptions.reconnectWait = validateInteger(value, options);
        break;
      case 'retries':
        replSetServersOptions.retries = validateInteger(value, options);
        break;
      case 'readSecondary':
      case 'read_secondary':
      ...
      case 'connectTimeoutMS':
        serverOptions.socketOptions.connectTimeoutMS = validateInteger(value, options);
        replSetServersOptions.socketOptions.connectTimeoutMS = validateInteger(value, options);
        mongosOptions.socketOptions.connectTimeoutMS = validateInteger(value, options);
        break;
      case 'socketTimeoutMS':
        serverOptions.socketOptions.socketTimeoutMS = validateInteger(value, options);
        replSetServersOptions.socketOptions.socketTimeoutMS = validateInteger(value, options);
        mongosOptions.socketOptions.socketTimeoutMS = validateInteger(value, options);
        break;
      case 'w':
        dbOptions.w = validateInteger(value, options);
      ...
      case 'authMechanismProperties':
        ...
        break;
      case 'wtimeoutMS':
        dbOptions.wtimeout = validateInteger(value, options);
        break;
      case 'readPreference':
      ...
      case 'maxStalenessSeconds':
        dbOptions.maxStalenessSeconds = validateInteger(value, options);
        break;
      ...
      case 'zlibCompressionLevel':
        compression = serverOptions.compression || {};
        var zlibCompressionLevel = validateInteger(value, options);
...
function validateInteger(value, options) {
  ...
  if (Number.isNaN(result)) {
    logger.warn('Expected an integer but got: ' + value);
